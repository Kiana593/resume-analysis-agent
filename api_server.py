...
from src.utils.llm import get_llm_config
...
def extract_resume(req: ExtractRequest) -> Dict[str, Any]:
    ...
    return extract_resume_profile(req.resume_text, req.position or None)
...
def modify(req: ModifyRequest) -> Dict[str, Any]:
    ...
    result = suggest_resume_edit(req.role, req.resume_text)
